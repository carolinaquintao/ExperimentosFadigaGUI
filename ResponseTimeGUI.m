function varargout = ResponseTimeGUI(varargin)
...
%     set(handles.Time,'String','OI')
    ...
    for i=1:1
        ...
        while toc(startTime) < 8
            if k==1
                ...
                set(handles.SentenceBox,'String',sentences(randi([1 length(sentences)],1,1)))
    ...
    set(handles.SentenceBox,'Enable','off')
%     csvwrite('EC_28_27042018_S4.csv',a);
